...
The `hive-mind-ingest` Click CLI still works via `docker compose exec`; both
...
from hive_mind_ingestion.pipeline_runner import run as ingest_run
...
async def lifespan(app: FastAPI):
    cfg = load_config()
    setup_otel("hive-mind-ingestion", cfg.telemetry.service_namespace)
...
app = FastAPI(title="hive-mind-ingestion", lifespan=lifespan)
